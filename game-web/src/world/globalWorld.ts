...
export const economicNodeIsOutsideLocality = (
  node: ExternalEconomicNode,
  localityIdsContainingNode: ReadonlySet<string>,
): boolean => !localityIdsContainingNode.has(node.nodeId)
