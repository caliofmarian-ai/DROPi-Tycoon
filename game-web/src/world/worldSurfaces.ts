...
export interface RectSurface extends SurfacePoint {
  width: number
  height: number
  centerline?: readonly SurfacePoint[]
  roadWidth?: number
}
...
export const surfaceContains = (rect: RectSurface, x: number, y: number, padding = 0): boolean => {
