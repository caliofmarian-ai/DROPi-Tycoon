...
/**
 * #324 keeps close inspection at 2.5x. #614 extends the lower bound so the 10x Brăila world can
 * reach a true semantic City overview on compact Android landscape instead of stopping at Area.
 */
export const CAMERA_MIN_ZOOM = 0.0015
