...
describe('Global Map runtime #418', () => {
  ...
  it('governs source-backed capital corrections without hardcoded coordinates', () => {
    ...
    expect(Object.keys(roleOverrideRegistry.entries).sort()).toEqual(['104', '144', '152', '226', '392', '710'])
    ...
    expect(localityCatalog.localityRoleOverrides?.countryIds).toEqual(['104', '144', '152', '226', '392', '710'])
  })
