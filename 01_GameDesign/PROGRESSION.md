...
# Player, Company and World Progression

## Purpose

This document defines how progression works in DROPi Tycoon.

Progression is not one company level and is not measured only by money.
...
- infrastructure;
- transport gateways;
- country/world participation;
- international networks;
- very-late-game frontier/off-world locations.

These axes influence one another but are not interchangeable.
...
A qualification can contain one or more of:
...
The in-world smartphone may provide eligible theory/study modules.
...
Practical capability may require:

- a school/training center;
- company department;
- instructor/qualified specialist;
- vehicle;
- workshop;
- simulator;
- DronePort;
- airport/port/rail facility;
- real in-game supervised work.

Completing theory alone does not automatically grant every practical capability.
...
A listed family is a canonical direction, not proof that it is currently implemented.
...
- related safety/maintenance specializations.
...
- aircraft/air-cargo theory;
- pilot or operational qualifications;
...
- future frontier/off-world logistics specializations.

New professions require deliberate canonical extension. Scenes must not invent unsupported specialist roles merely because a physical room exists.
...
- multiplayer competition/cooperation;
- shared-world governance.
...
- global optimization;
- very-late-game frontier/space/planetary logistics.
...
- a workshop creates a place for maintenance specialization;
- a trained mechanic makes advanced workshop functions useful;
- a DronePort creates drone-operational opportunity;
...
Unbuilt departments are not operational.

See `HQ_PROGRESSION.md`.
...
Transport choice may trade off:
...
**Neighborhood -> locality -> city -> region/county -> country/logical world -> international network -> frontier/off-world.**

World access may depend on:
...
Some online foundations must arrive before mature shared ownership/markets can exist.
...
After major horizons, players can continue improving:
...
A temporary implementation value is not permanent canon unless explicitly approved.
...
- reputation/reviews;
- employees;
- productive employee-fleet activity;
