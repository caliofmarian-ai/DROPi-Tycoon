...
assert.match(source, /dropi:startup-cinematic-dismissed/)
...
assert.match(source, /ownerEvalLoopback/)
assert.match(source, /window\.location\.port === '17832'/)
assert.match(source, /dropi:presentation:startup-world-film:v4/)
