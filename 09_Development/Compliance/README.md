...
This directory contains release-specific compliance evidence. It does not replace the canonical legal/privacy/IP governance documents under `00_Project/` and does not constitute legal advice.

Current evidence packages:

- `CURRENT_RELEASE_DATA_FLOW_569.md` — current production-source data-flow inventory for Google Play privacy/Data Safety review.
- `GOOGLE_PLAY_APP_CONTENT_EVIDENCE_569.md` — source-level App Content evidence.
- `GOOGLE_PLAY_DATA_SAFETY_EVIDENCE_569.md` — conditional Data Safety evidence pending exact release-artifact verification.
- `GOOGLE_PLAY_RELEASE_DECLARATION_CHECKLIST_569.md` — final declaration/revalidation checklist.
